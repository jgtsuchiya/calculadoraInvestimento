function covertToMontlyReturnRate(yearlyReturnRate) {
...
export function generateReturnsArray(
    ...
    if (!timeHorizon || !startingAmount) {
        throw new Error('Investimento inicial e prazo dever ser preenchidos com valores positivos');
    }

    const finalReturnRate = returnTimeFrame === 'monthly'
        ? 1 + (returnRate / 100)
        : covertToMontlyReturnRate(1 + (returnRate / 100));
